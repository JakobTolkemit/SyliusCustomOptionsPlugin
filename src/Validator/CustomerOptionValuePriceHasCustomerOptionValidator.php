...
use Brille24\SyliusCustomerOptionsPlugin\Validator\Constraints\CustomerOptionPriceOverrideHasCustomerOptionConstraint;
...
class CustomerOptionValuePriceHasCustomerOptionValidator extends ConstraintValidator
{
    ...
    public function validate($product, Constraint $constraint): void
    {
        ...
        Assert::isInstanceOf(
            $constraint,
            CustomerOptionPriceOverrideHasCustomerOptionConstraint::class,
            sprintf('$constraint is not type of %s', CustomerOptionPriceOverrideHasCustomerOptionConstraint::class)
        );
